...
- **Check existing issues**: Before opening a new issue, search the [issue tracker](https://github.com/simvia-tech/med2limit/issues) to avoid duplicates.
- **Open a new issue**: If the bug hasn't been reported, create a new issue with a clear title and description. Include:
  ...
  - Your environment (python and medcoupling version, etc).
...
4. **Commit your changes** with a descriptive message (e.g., `fix: correct shell numbering`).
...
Email: [**dorian.nezzar@simvia.tech**](mailto:dorian.nezzar@simvia.tech)
